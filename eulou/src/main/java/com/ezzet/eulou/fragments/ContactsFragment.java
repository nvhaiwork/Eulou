...
public class ContactsFragment extends Fragment
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		mInstargramBtn = (ImageView) rootView
	...
	public boolean onQueryTextChange(String arg0) {
		...
		if (arg0.equals("")) {
			...
			friendsFilterArray = filterFriendsList(arg0);
			contactsFilterArray = filterContactList(arg0);
		}
	...
	public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
		...
		UserInfo user = (UserInfo) adapterView.getAdapter().getItem(i);
		Intent friendProfileIntent = new Intent(getActivity(),
				FriendProfileActivity.class);
		friendProfileIntent.putExtra(Constants.INTENT_FRIEND_PROFILE_USER_INFO,
				user);
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (convertView != null) {
				...
				layoutItem = (RelativeLayout) inflater.inflate(
						R.layout.layout_friend_list_item, null);
			}
			...
			FBProfilePictureView profileView = (FBProfilePictureView) layoutItem
					.findViewById(R.id.friend_profile);
			profileView.setProfileId(user.getFacebookID());
			TextView textViewName = (TextView) layoutItem
