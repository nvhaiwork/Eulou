...
public class CustomSharedPreferences {
    ...
    public static void init(final Context context) {
        ...
        if (null != context) {
            ...
            if (mSharedPre == null) {
                ...
                mSharedPre = context.getSharedPreferences(CUSTOM_SHAREDPREFERNCES, Context.MODE_PRIVATE);
            }
    ...
    private static void refresh() {
        if (null != mContext) {
            ...
            mSharedPre = mContext.getSharedPreferences(CUSTOM_SHAREDPREFERNCES, 0);
            mEditor = mSharedPre.edit();
        } else {
