...
public class EulouService extends Service {
    ...
    public void onCreate() {
        ...
        SharedPreferences prefs = getSharedPreferences("Eulou", MODE_PRIVATE);
        ...
        IntentFilter filter = new IntentFilter("com.ezzet.eulou.action.CALLBUTTON");
        ...
        if (activeSession == null || activeSession.isOpened() == false) {
            ...
            Request.newMyFriendsRequest(Session.getActiveSession(), new GraphUserListCallback() {
                        ...
                        public void onCompleted(List<GraphUser> users, Response response) {
                            if (users == null) {
                                Toast.makeText(EulouService.this.getApplicationContext(), "Failed to retrieve friends list.", Toast.LENGTH_LONG).show();
                                return;
                            }
    ...
    private void requestFriendsService(String ids) {
        String requestString = Constants.EULOU_SERVICE_URL + "?action=" + Constants.API_USERS_BY_SOCIALIDS + "&socialids=" + ids;
        ...
        client.get(requestString, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                ...
                try {
                    ...
                    e.printStackTrace();
                    Toast.makeText(EulouService.this.getApplicationContext(), "You have 0 contacts, you can invite friends to join you in Eulou !", Toast.LENGTH_LONG).show();
                    return;
                }
            ...
            public void onFailure(int statusCode, Header[] headers, byte[] responseBody, Throwable error) {
                ...
                Toast.makeText(EulouService.this.getApplicationContext(), "Failed to retrieve friend users.", Toast.LENGTH_LONG).show();
                return;
    ...
    private class CallButtonReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            CallClient callClient = mSinchClientService.getSinchClient().getCallClient();
            Call call = callClient.callUser(userIDString);
            CurrentCall.currentCall = call;
            Intent callIntent = new Intent(EulouService.this, CallScreenActivity.class);
    ...
    class AsyncContact extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                ArrayList<HashMap<String, String>> contacts = hf.getAllContacts();
                ...
                if (cd.isConnectingToInternet()) {
                    ...
                    BaseActivity.mContactUsers = hf.getAllUSer(String.valueOf(BaseActivity.mUserInfo.getUserID()), s.toString());
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
