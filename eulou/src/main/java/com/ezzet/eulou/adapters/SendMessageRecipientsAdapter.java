...
public class SendMessageRecipientsAdapter extends BaseAdapter {
    ...
    public View getView(int pos, View convertView, ViewGroup parrent) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.layout_send_message_friend_list_item, parrent, false);

            holder.profilePic = (FBProfilePictureView) convertView.findViewById(R.id.send_message_friend_image);
            holder.username = (TextView) convertView.findViewById(R.id.send_message_friend_name);
            holder.userType = (ImageView) convertView.findViewById(R.id.send_message_friend_type);
