...
public class CallsListAdapter extends BaseAdapter {
    ...
    public View getView(int pos, View convertView, ViewGroup arg2) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.recent_calls_list_item, arg2, false);
            holder.profilePicture = (FBProfilePictureView) convertView.findViewById(R.id.profilePictureView);
            holder.userName = (TextView) convertView.findViewById(R.id.textViewName);
            holder.callTypeIcon = (ImageView) convertView.findViewById(R.id.imageViewCallType);
            holder.callType = (TextView) convertView.findViewById(R.id.textViewCallType);
            holder.callTime = (TextView) convertView.findViewById(R.id.textViewTime);
            holder.detailBtn = (ImageView) convertView.findViewById(R.id.buttonDetail);
        ...
        if (item.direction.equalsIgnoreCase("outgoing")) {
            ...
            holder.callType.setTextColor(mContext.getResources().getColor(R.color.dark_gray));
            ...
            holder.callType.setText(String.format("Missed call (%s)", item.count));
            holder.callType.setTextColor(mContext.getResources().getColor(R.color.red));
        }
