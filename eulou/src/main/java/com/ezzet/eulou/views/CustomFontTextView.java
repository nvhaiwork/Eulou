    ...
    public void setFont() {
        ...
        switch (style) {
            ...
            case 2:
                ...
                typeFace = Typeface.createFromAsset(getContext().getAssets(), "Roboto-LightItalic.ttf");
                break;
            case 3:

                typeFace = Typeface.createFromAsset(getContext().getAssets(), "Roboto-BoldItalic.ttf");
                break;
            default:
